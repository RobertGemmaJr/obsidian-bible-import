...
geneva_bible = BIBLES_PATH / "bibles_sqlite_6" / "EN-English" / "geneva.sqlite"


def read_geneva_bible():
    print("Reading Geneva Bible translation:", geneva_bible)

    # Read the SQLite source
    meta, verse_rows = read_sqlite_translation(geneva_bible)
