...
kjv_bible = BIBLES_PATH / "bibles_sqlite_6" / "EN-English" / "kjv.sqlite"


def read_kjv_bible():
    print("Reading KJV Bible translation:", kjv_bible)

    # Read the SQLite source
    meta, verse_rows = read_sqlite_translation(kjv_bible)
