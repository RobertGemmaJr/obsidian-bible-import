...
tyndale_bible = BIBLES_PATH / "bibles_sqlite_6" / "EN-English" / "tyndale.sqlite"
...
def read_tyndale_bible():
    ...
    with Session(DB_ENGINE) as session:
        ...
        # Create the verses
        # NOTE: Tyndale only covers a partial set of books (33 of 66). Missing books
        # NOTE: will simply never appear in the verses table.
