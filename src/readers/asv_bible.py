...
asv_bible = BIBLES_PATH / "bibles_sqlite_6" / "EN-English" / "asv.sqlite"


def read_asv_bible():
    print("Reading ASV Bible translation:", asv_bible)

    # Read the SQLite source
    meta, verse_rows = read_sqlite_translation(asv_bible)
