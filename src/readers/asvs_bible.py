...
asvs_bible = BIBLES_PATH / "bibles_sqlite_6" / "EN-English" / "asvs.sqlite"


def read_asvs_bible():
    print("Reading ASVs Bible translation:", asvs_bible)

    # Read the SQLite source
    meta, verse_rows = read_sqlite_translation(asvs_bible)
