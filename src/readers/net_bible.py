...
net_bible = BIBLES_PATH / "bibles_sqlite_6" / "EN-English" / "net.sqlite"


def read_net_bible():
    print("Reading NET Bible translation:", net_bible)

    # Read the SQLite source
    meta, verse_rows = read_sqlite_translation(net_bible)
